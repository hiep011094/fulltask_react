  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      if (file) {
        ...
        const res1 = await axios.post('http://react-mern123.herokuapp.com/api/v1/upload_avatar', formatData, {
          headers: { Authorization: token }
        })
        avatar = res1.data.url;
      }

      const res = await axios.patch('http://react-mern123.herokuapp.com/api/v1/user/update', {
        name: input.name,
        phone: input.phone,
